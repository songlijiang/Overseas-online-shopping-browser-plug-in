...
function PluginContent(){
	...
	this.search_box_init = function(){
		...
		if(search_input&&search_input.length>0){
			//添加翻译提示框
			var search_tip_obj = $('<div id="'+PluginConf.css_refix+'search_tip_main">可以直接输入中文，零米海淘帮您翻译</div>').prependTo($('body'));
	...
	this.refresh_price = function(){
		...
		$("#"+PluginConf.css_refix+"foreignPriceValue").text((_this.goodsPrice/_this.exchange_rate).toFixed(2));
		$("#"+PluginConf.css_refix+"rmbPriceValue").text(_this.goodsPrice);
	...
	this.append_feature_others= function (){  
		_this.proSize = _this.get_features().sizes;
		_this.proColor = _this.get_features().colors;
		_this.proFlavor = _this.get_features().flavors;
		_this.proStyle = _this.get_features().styles;
		_this.proWidth = _this.get_features().widths;
		_this.proInseam = _this.get_features().inseams;
		var ProSize =' <div id="'+PluginConf.css_refix+'proSize"><strong class="'+PluginConf.css_refix+'strong">商品尺寸 : </strong> <span class="'+PluginConf.css_refix+'warn" >'+_this.proSize+'</span></div> ';
		var ProColor =' <div id="'+PluginConf.css_refix+'proColor"><strong class="'+PluginConf.css_refix+'strong">商品颜色 : </strong> <span class="'+PluginConf.css_refix+'warn" >'+_this.proColor+'</span></div> ';
		var ProFlavor =' <div id="'+PluginConf.css_refix+'proFlavor"><strong class="'+PluginConf.css_refix+'strong">商品口味 : </strong><span class="'+PluginConf.css_refix+'warn" >'+_this.proFlavor+'</span> </div> ';
		var ProStyle =' <div id="'+PluginConf.css_refix+'proStyle"><strong class="'+PluginConf.css_refix+'strong">商品风格 : </strong><span class="'+PluginConf.css_refix+'warn" >'+_this.proStyle+'</span> </div> ';
		var ProWidth =' <div id="'+PluginConf.css_refix+'proWidth"><strong class="'+PluginConf.css_refix+'strong">商品宽度 : </strong><span class="'+PluginConf.css_refix+'warn" >'+_this.proWidth+'</span> </div> ';
		var ProInseam =' <div id="'+PluginConf.css_refix+'proInseam"><strong class="'+PluginConf.css_refix+'strong">商品长度 : </strong><span class="'+PluginConf.css_refix+'warn" >'+_this.proInseam+'</span> </div> ';
