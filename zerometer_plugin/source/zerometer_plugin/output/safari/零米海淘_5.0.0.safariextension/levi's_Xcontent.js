function localStartX(){
	...
	return function(plugin_content){
		...
		plugin_content.site_id = 27;
		plugin_content.site_name = "levi's";
		...
		plugin_content.get_features = function(){
			...
			function getWaistOrSizeNames(){
			  var value = "";
			  var hasAttr = false;
			  if($("#pdp-buystack-waist-values").find("li").length >0)
			  {
			  	hasAttr =true;
			  }
			...
			function getInseamNames(){
			  var value = "";
			  var hasAttr =false;
			  if($("#pdp-buystack-length-values").find("li").length >0)
			  {
			  	hasAttr = true;
			  }
			...
			function getClothesSizeNames(){
			  var value = "";
			  var hasAttr = false;
			  if( $("#pdp-buystack-size-values").find("li").length >0)
			  {
			  	hasAttr = true;	
			  }
